...
type RegisterResult struct {
	Success *user.RegisterRsp
}

var RegisterResult_Success_DEFAULT *user.RegisterRsp

func (p *RegisterResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.RegisterRsp)
	}
...
func (p *RegisterResult) GetSuccess() *user.RegisterRsp {
	if !p.IsSetSuccess() {
...
type LoginResult struct {
	Success *user.LoginRsp
}

var LoginResult_Success_DEFAULT *user.LoginRsp

func (p *LoginResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.LoginRsp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *LoginResult) GetSuccess() *user.LoginRsp {
	if !p.IsSetSuccess() {
...
func (p *kClient) Register(ctx context.Context, Req *user.RegisterReq) (r *user.RegisterRsp, err error) {
...
func (p *kClient) Login(ctx context.Context, Req *user.LoginReq) (r *user.LoginRsp, err error) {
	var _args LoginArgs
	_args.Req = Req
